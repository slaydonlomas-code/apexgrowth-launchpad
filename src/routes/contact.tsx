        ...
        <div className="mx-auto grid max-w-6xl gap-14 px-5 md:px-8 lg:grid-cols-[1fr_1.2fr]">
          <div>
            ...
            <div className="mt-8 space-y-4">
              <a href={CONTACT.phoneHref} className="flex items-center gap-3 text-foreground/90 transition hover:text-primary">
              ...
              <a href={`mailto:${CONTACT.email}`} className="flex items-center gap-3 break-all text-foreground/90 transition hover:text-primary">
